...
description: "Google transforms the Play Store gaming section with a new interface that weights reviews based on the user's specific device and hardware."
...
1. **Dynamic Video Headers:** Autoplay trailers (silenced by default) that use less data.
2. **Compatibility Badges:** A clear indicator showing if a game supports high-refresh rates (90/120Hz) or specific controllers for your detected device.
3. **Sentiment Snippets:** AI-generated summaries of reviews that highlight common technical praise or complaints relevant to your hardware.
